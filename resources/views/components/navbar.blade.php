    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <img src="{{ asset('images/logo.png') }}" class="mr-3 h-8" alt="NIIS Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">E-Raport</span>
            </a>
