                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <a href="/tujuanpembelajaran"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tujuan
                            Pembelajaran</a>
                    </li>
                    <li>
                        <a href="/lingkupmateri"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Lingkup
                            Materi</a>
                    </li>
                    <li>
                        <a href="/asesmenformatif"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Asesmen
                            Formatif</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/penilaianekstrkulikuler"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Penilaian
                            Ekstrakulikuler</a>
                    </li>
                    <li>
                        <a href="/nilaiakhir"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Nilai
                            Akhir</a>
                    </li>
                </ul>
            </li>
            <li>
                <button type="button"
                    ...
                    <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"
                        class="flex-shrink-0 w-6 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Mapel
                            Intrakurikuler</a>
                    </li>
                    <li>
                        <a href="#"
