<section class="relative bg-stone-50 mt-4">
    <div class="bg-sky-400 w-full sm:w-40 h-40 rounded-full absolute top-1 opacity-20 max-sm:right-0 sm:left-56 z-0">
    </div>
    <div class="bg-emerald-500 w-full sm:w-40 h-24 absolute top-0 -left-0 opacity-20 z-0">
    </div>
    <div class="bg-purple-600 w-full sm:w-40 h-24 absolute top-40 -left-0 opacity-20 z-0">
    </div>
                    ...
                    <div class="flex gap-5 flex-col">
                        <div class="p-6 rounded-xl bg-white">
                            ...
                            <h6 class="text-xl leading-8 font-semibold text-black mb-1">
                                Meeting with a friends</h6>
                            <p class="text-base font-normal text-gray-600">
                                Meet-Up for Travel Destination
                                Discussion</p>
                        </div>
                        <div class="p-6 rounded-xl bg-white">
                            <div class="flex items-center justify-between mb-3">
                            ...
                            <h6 class="text-xl leading-8 font-semibold text-black mb-1">
                                Visiting online courcse</h6>
                            <p class="text-base font-normal text-gray-600">
                                Checks updates for design course</p>
                        </div>
                        <div class="p-6 rounded-xl bg-white">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-2.5">
                            ...
                            <h6 class="text-xl leading-8 font-semibold text-black mb-1">
                                Development meet</h6>
                            <p class="text-base font-normal text-gray-600">
                                Discussion with developer for upcoming
                                project</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        - 11:00</span>
                                    <p class="xl:hidden w-2 h-2 rounded-full bg-purple-600">
                                    </p>
                                </div>
                            </div>
                            <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <span
                                        ...
                                        - 11:00</span>
                                    <p class="xl:hidden w-2 h-2 rounded-full bg-emerald-600">
                                    </p>
                                </div>
                            </div>
                            <div
                            ...
                            <div
                                ...
                                <div class="absolute top-9 bottom-1 left-3.5 p-1.5 xl:px-2.5 h-max rounded bg-sky-50 ">
                                    ...
                                    <span
                                        ...
                                        - 11:00</span>
                                    <p class="xl:hidden w-2 h-2 rounded-full bg-sky-600">
                                    </p>
                                </div>
                            </div>
                            <div
